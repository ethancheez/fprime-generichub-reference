// ======================================================================
// \title  NativePiDeploymentTopology.cpp
// \brief cpp file containing the topology instantiation code
//
// ======================================================================
// Provides access to autocoded functions
#include <NativePiDeployment/Top/NativePiDeploymentTopologyAc.hpp>
#include <NativePiDeployment/Top/NativePiDeploymentPacketsAc.hpp>
...
void configureTopology() {
    ...
    // tlmSend.setPacketList(NativePiDeploymentPacketsPkts, NativePiDeploymentPacketsIgnore, 1);
...
// Public functions for use in main program are namespaced with deployment name NativePiDeployment
...
void startSimulatedCycle(U32 milliseconds) {
    ...
    // Main loop
    while (cycling) {
        NativePiDeployment::blockDrv.callIsr();
