// ======================================================================
// \title  NativePiDeploymentTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef NATIVEPIDEPLOYMENT_NATIVEPIDEPLOYMENTTOPOLOGY_HPP
#define NATIVEPIDEPLOYMENT_NATIVEPIDEPLOYMENTTOPOLOGY_HPP
// Included for access to NativePiDeployment::TopologyState and NativePiDeployment::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <NativePiDeployment/Top/NativePiDeploymentTopologyDefs.hpp>

// Remove unnecessary NativePiDeployment:: qualifications
using namespace NativePiDeployment;
 ...
 * NativePiDeployment::TopologyState see: NativePiDeploymentTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type NativePiDeployment::TopologyState see: NativePiDeploymentTopologyDefs.hpp.
 *
