module RemoteDeployment {
  ...
  topology RemoteDeployment {
    ...
    event connections instance remote_eventLogger
    ...
    connections FaultProtection {
      remote_eventLogger.FatalAnnounce -> remote_fatalHandler.FatalReceive
    }
    ...
    connections RateGroups {
      ...
      remote_rateGroup3.RateGroupMemberOut[1] -> remote_blockDrv.Sched
      remote_rateGroup3.RateGroupMemberOut[2] -> remote_bufferManager.schedIn
    ...
    connections HubToDriver {
      ...
      remote_comQueue.comQueueSend -> remote_hubFramer.comIn
      remote_comQueue.buffQueueSend -> remote_hubFramer.bufferIn
      remote_hubFramer.comStatusOut -> remote_comQueue.comStatusIn
      remote_hubFramer.bufferDeallocate -> remote_bufferManager.bufferSendIn
      remote_hubFramer.framedAllocate -> remote_bufferManager.bufferGetCallee
      remote_hubFramer.framedOut -> remote_comStub.comDataIn
      remote_comStub.comStatus -> remote_hubFramer.comStatusIn
      remote_comStub.drvDataOut -> remote_hubDriver.$send
      remote_hubDriver.deallocate -> remote_bufferManager.bufferSendIn
      remote_hubDriver.ready -> remote_comStub.drvConnected

      # Uart Driver -> Deframer -> Hub
      remote_hubDriver.allocate -> remote_bufferManager.bufferGetCallee
      remote_hubDriver.$recv -> remote_comStub.drvDataIn
      remote_comStub.comDataOut -> remote_hubDeframer.framedIn
      remote_hubDeframer.framedDeallocate -> remote_bufferManager.bufferSendIn
      remote_hubDeframer.bufferAllocate -> remote_bufferManager.bufferGetCallee
      remote_hubDeframer.bufferOut -> remote_hub.dataIn
      remote_hub.dataInDeallocate -> remote_bufferManager.bufferSendIn

      remote_hub.buffersOut -> remote_bufferManager.bufferSendIn
    }
    ...
    connections HubToDeployment {
      ...
      # File Uplink
      remote_hub.portOut[2] -> remote_fileUplink.bufferSendIn
      remote_fileUplink.bufferSendOut -> remote_hub.portIn[2]
    }
