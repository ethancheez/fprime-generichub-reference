// ======================================================================
// \title  RemoteDeploymentTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef REMOTEDEPLOYMENT_REMOTEDEPLOYMENTTOPOLOGY_HPP
 ...
 * RemoteDeployment::TopologyState see: RemoteDeploymentTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type RemoteDeployment::TopologyState see: RemoteDeploymentTopologyDefs.hpp.
 *
